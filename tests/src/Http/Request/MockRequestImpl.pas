...
resourcestring
    ...
    constructor TMockRequest.create(
        const anUri : IUri;
        const aheaders : IReadOnlyHeaders;
        const env : ICGIEnvironment;
        const query : IList;
     ...
     * @return header instance
     *-------------------------------------*)
    function TMockRequest.headers() : IReadOnlyHeaders;
    begin
        result := fHeaders;
    end;
     ...
     * @return IUri of current request
     *------------------------------------------------*)
    function TMockRequest.uri() : IUri;
    begin
        result := fUri;
    end;

    procedure TMockRequest.clearParams(const aparams : IList);
    var i, len : integer;
        param : PKeyValue;
    begin
        len := aparams.count();
    ...
    procedure TMockRequest.initParamsFromString(
        const data : string;
        const body : IList;
        const separatorChar : char = '&'
    );
    ...
    procedure TMockRequest.initQueryParamsFromEnvironment(
        const env : ICGIEnvironment;
        const query : IList
    );
    begin
    ...
    procedure TMockRequest.initCookieParamsFromEnvironment(
        const env : ICGIEnvironment;
        const cookies : IList
    );
    begin
    ...
    procedure TMockRequest.raiseExceptionIfPostDataTooBig(const contentLength : int64);
    begin
    ...
    procedure TMockRequest.initPostBodyParamsFromStdInput(
        const env : ICGIEnvironment;
        const body : IList
    );
    ...
    procedure TMockRequest.initBodyParamsFromStdInput(
        const env : ICGIEnvironment;
        const body : IList
    );
    var amethod : string;
    ...
    procedure TMockRequest.initParamsFromEnvironment(
        const env : ICGIEnvironment;
        const query : IList;
        const cookies : IList;
        const body : IList
     ...
     * @return string value
     *------------------------------------------------*)
    function TMockRequest.getSingleParam(
        const src : IReadOnlyList;
        const key: string;
        const defValue : string = ''
    ) : string;
     ...
     * @return string value
     *------------------------------------------------*)
    function TMockRequest.getQueryParam(const key: string; const defValue : string = '') : string;
    begin
     ...
     *------------------------------------------------*)
    function TMockRequest.getQueryParams() : IReadOnlyList;
    begin
        result := queryParams;
    end;
     ...
     * @return string value
     *------------------------------------------------*)
    function TMockRequest.getCookieParam(const key: string; const defValue : string = '') : string;
    begin
     ...
     *------------------------------------------------*)
    function TMockRequest.getCookieParams() : IReadOnlyList;
    begin
        result := cookieParams;
    end;
     ...
     * @return string value
     *------------------------------------------------*)
    function TMockRequest.getParsedBodyParam(const key: string; const defValue : string = '') : string;
    begin
     ...
     *------------------------------------------------*)
    function TMockRequest.getParsedBodyParams() : IReadOnlyList;
    begin
        result := bodyParams;
    end;
     ...
     *------------------------------------------------*)
    function TMockRequest.getUploadedFile(const key: string) : IUploadedFileArray;
    begin
     ...
     *------------------------------------------------*)
    function TMockRequest.getUploadedFiles() : IUploadedFileCollection;
    begin
     ...
     *------------------------------------------------*)
    function TMockRequest.isXhr() : boolean;
    begin
     ...
     * @return ICGIEnvironment
     *------------------------------------------------*)
    function TMockRequest.getEnvironment() : ICGIEnvironment;
    begin
     ...
     * @return string value
     *------------------------------------------------*)
    function TMockRequest.getParam(const key: string; const defValue : string = '') : string;
    begin
     ...
     * @return list of request query string parameters
     *------------------------------------------------*)
    function TMockRequest.getParams() : IReadOnlyList;
    begin
