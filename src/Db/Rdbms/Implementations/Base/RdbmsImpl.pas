...
resourcestring
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramUtf8(const strName : string; const strValue : utf8string) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asUtf8String := strValue;
        result := self;
    end;
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramUnicode(const strName : string; const strValue : unicodestring) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asUtf8String := strValue;
        result := self;
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramSmallInt(const strName : string; const strValue : smallint) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asSmallInt := strValue;
        result := self;
    end;
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramWord(const strName : string; const strValue : word) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asWord := strValue;
        result := self;
    end;
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramLargeInt(const strName : string; const strValue : largeint) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asLargeInt := strValue;
        result := self;
    end;
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramBool(const strName : string; const strValue : boolean) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asBoolean := strValue;
        result := self;
    end;
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramCurrency(const strName : string; const strValue : currency) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asCurrency := strValue;
        result := self;
    end;
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramDate(const strName : string; const strValue : TDateTime) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asDate := strValue;
        result := self;
    end;
     ...
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramTime(const strName : string; const strValue : TDateTime) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asTime := strValue;
        result := self;
    end;

    (*!------------------------------------------------
     * set parameter bytes value
     *-------------------------------------------------
     * @return current statement
     *-------------------------------------------------*)
    function TRdbms.paramBytes(const strName : string; const strValue : TBytes) : IRdbmsStatement;
    begin
        raiseExceptionIfInvalidConnection();
        fQuery.params.paramByName(strName).asBytes := strValue;
        result := self;
    end;
end.
